...
dataset=pd.read_csv("CustomersDataset.csv")
...
print("logistic report:",classification_report(Y_test_l,Y_pred_L))
...
SVRModel = SVC(kernel='rbf',C=40,tol=0.0000000001,max_iter=100000,probability=True) 
...
print(DecisionTreeModel.predict(X_tree.iloc[:10]))
print(Y_tree.iloc[:10])
